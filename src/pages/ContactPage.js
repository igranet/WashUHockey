...
const buttStyle = "bg-red-400 md:px-4 px-2 py-4 text-white text-sm md:text-xl text-center mt-4 w-full md:w-full rounded-lg hover:bg-red-600 duration-400"
    return ( 
        <>
        <NavBar></NavBar>
        
    <div className="w-full flex">
        <div className="mx-auto w-2/3 md:w-1/3 mt-24 text-4xl text-center font-semibold">
            <p>Need to get in touch? <br></br>Select an option below!</p>
            <div className="w-full md:w-2/3 flex flex-col mx-auto text-center mt-12">
    ...
    {/* <FooterBar></FooterBar> */}
    <footer className="opacity-0 md:opacity-100 h-18 bg-gray-700 mt-24 border-t-2 border-black flex flex-col bottom-0 absolute w-full">
